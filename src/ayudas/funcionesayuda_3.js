...
funcionesAyuda_3.funcion_tiempo_estado = function (datos_tiempo) {
    ...
    if (datos_tiempo.estado == "construido") {
        ...
        if (datos_tiempo.estado == "guardado") {
            ...
            var factor_tiempo_porcentaje = ((tiempo_transcurrido / tiempo_duracion) * 100).toFixed(
                2
            );
        }
    }
...
/*************************************************************************************/
// PRECIOS HISTORICOS $us/m2
// ACTUALIZAR ACORDE AL MERCADO
funcionesAyuda_3.funcion_sus_m2_historicos = function (datos_auxiliares) {
    var tipo_inmueble = datos_auxiliares.tipo_inmueble;
    ...
    if (
        ...
        var array_sus_m2 = [
            779, 793.5, 808, 809.5, 811, 822, 823, 795, 801, 824, 869, 820, 836.4, 853.13, 870.19,
            872, 880.8, 876.14, 889.49, 884.73, 898.17, 893.33, 906.86, 901.93, 915.55, 910.53,
            924.23, 919.12, 932.92, 927.72, 941.6, 936.32, 950.29, 944.92, 958.98, 953.51, 967.66,
            962.11, 976.35, 970.71, 985.03, 979.31, 993.72, 987.9, 1002.4, 996.5, 1011.09, 1005.1,
            1019.78, 1013.69, 1028.46, 1022.29, 1037.15, 1030.89, 1045.83, 1039.49, 1054.52,
            1048.08, 1063.2, 1056.68, 1071.89, 1065.28, 1080.58, 1073.88, 1089.26, 1082.47, 1097.95,
            1091.07, 1106.63, 1099.67, 1115.32, 1108.27, 1124.01, 1116.86, 1132.69, 1125.46,
            1141.38, 1134.06, 1150.06, 1142.66, 1158.75, 1151.25, 1167.43, 1159.85, 1176.12,
            1168.45, 1184.81, 1177.04, 1193.49, 1185.64, 1202.18, 1194.24, 1210.86, 1202.84,
            1219.55, 1211.43, 1228.23, 1220.03, 1236.92, 1228.63, 1245.61, 1237.23, 1254.29,
            1245.82, 1262.98, 1254.42, 1271.66, 1263.02, 1280.35, 1271.62, 1289.03, 1280.21,
            1297.72, 1288.81, 1306.41, 1297.41, 1315.09, 1306.01, 1323.78, 1314.6, 1332.46, 1323.2,
            1341.15, 1331.8, 1349.84, 1340.39, 1358.52, 1348.99, 1367.21, 1357.59, 1375.89, 1366.19,
            1384.58, 1374.78, 1393.26, 1383.38, 1401.95, 1391.98, 1410.64, 1400.58, 1419.32,
            1409.17, 1428.01, 1417.77, 1436.69, 1426.37, 1445.38, 1434.97, 1454.06, 1443.56,
            1462.75, 1452.16, 1471.44, 1460.76, 1480.12, 1469.36, 1488.81, 1477.95, 1497.49,
            1486.55, 1506.18, 1495.15, 1514.87, 1503.74, 1523.55, 1512.34, 1532.24, 1520.94,
            1540.92, 1529.54,
        ];
...
/*************************************************************************************/
// TIPO DE CAMBIO DOLAR A BOLIVIANOS
// ACTUALIZAR ACORDE AL MERCADO
funcionesAyuda_3.tipo_cambio = function () {
    // 1 $US = 7 BS
    var tipo_cambio = 7;
    var obj_tc = {
        tipo_cambio,
