...
const imagenesSistemaEsquema = new Schema({
    ...
    completo: { type: String, default: "" }, // AHORA SE ALMACENA LA url DONDE SE ENCUENTRA ALMACENADA LA IMAGEN. EJ/ https://firebasestorage.googleapis.com/v0/b/solidexa-firebase.appspot.com/o/imagenes_sistema%2Fcabecera_construccion.jpg?alt=media&token=ccb9b2b8-9c91-4cf0-ac36-2e012cb0f917
    
    // ANTERIORMENTE SE ALMACENABA EJ/  "cabecera_convocatoria.jpg", "inicio_horizontal.jpg"
});
